...
> [!TIP]
> To deploy this project using **GUI-based flow**, navigate to [console](https://console.stacktape.com/create-new-project/git-project-using-console?name=my-stacktape-app&repositoryType=public&repositoryUrl=https://github.com/stacktape/starter-spring-boot-api-postgres)

- simple HTTP API built using [Spring Boot](https://spring.io/projects/spring-boot).
...
```bash
stacktape init --starterId spring-boot-api-postgres
```
